...
public class BluthMain : MonoBehaviour
{
    [Header("Debugging")]
    ...
    {
        Debug.LogWarning("BluthMain.InitialiseDebugging(): Debugging mode initialised! Override values will be used.");
    ...
    void OnGUI()
    {
        ...
        if (EnableDebugging)
        {
            ...
            GUILayout.Label("Bluth Debugging Mode Enabled");
            GUILayout.EndArea();
        }
#endif
    }
